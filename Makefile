...
sample : ordering slides sample/papers.csv sample/conflicts.csv sample/pc.csv
	@echo "RUNNING SAMPLE..."
	(cd sample; ../ordering papers.csv conflicts.csv pc.csv >schedule.csv; ../check papers.csv schedule.csv; diff -u schedule.expected schedule.csv; ../slides schedule.csv pc.csv > slides.tex; pdflatex slides.tex)
	@echo "DONE."
...
test : ordering slides papers.csv conflicts1.csv conflicts2.csv conflicts3.csv allpapers.csv pc.csv
	...
	./check nonpcpapers.csv.test schedule.csv.test
